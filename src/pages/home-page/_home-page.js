...
export default () => (
  <Layout>
    <div className={styles.container}>
      ...
      <div
        id={styles.simonTeacherContainer}
      ...
      >
        <div id={styles.abigailTeacherContainer}>
          ...
          <div className={styles.teacherText}>
            <p>
              ...it's a job that is full of rewards and you have the privilege
              of seeing children progress, grow and shine during their time with
              you. There is no greater feeling.
            </p>
